...
public class StatementWrapper extends BaseObject {
    ...
    @Signature({@Arg(value = "sql"), @Arg(value = "autoGeneratedKeys", optional = @Optional("NULL"))})
    public Memory execute(Environment env, Memory... args) {
        try {
            if (args[1].isNull()) {
                mStatement.execute(args[0].toString());
            } else {
                mStatement.execute(args[0].toString(), args[1].toInteger());
            }
        } catch (SQLException e) {
            DriverManagerWrapper.exception(env, e.getMessage());
        }
    ...
    @Signature({@Arg(value = "sql"), @Arg(value = "columnIndexes", type = ARRAY)})
    public Memory executeWithIndexes(Environment env, Memory... args) {
        try {
            String sql = args[0].toString();
            ArrayMemory arr = (ArrayMemory) args[1];
            mStatement.execute(sql, MemoryUtil.toIntArray(arr));
        } catch (SQLException e) {
            DriverManagerWrapper.exception(env, e.getMessage());
        }
        return NULL;
    ...
    @Signature({@Arg(value = "sql"), @Arg(value = "columnNames", type = ARRAY)})
    public Memory executeWithNames(Environment env, Memory... args) {
        try {
            String sql = args[0].toString();
            ArrayMemory arr = (ArrayMemory) args[1];
            mStatement.execute(sql, MemoryUtil.toStringArray(arr));
        } catch (SQLException e) {
            DriverManagerWrapper.exception(env, e.getMessage());
        }
        return NULL;
    ...
    public Memory executeUpdate(Environment env, Memory... args) {
        try {
            if (args[1].isNull()) {
                ...
                return LongMemory.valueOf(mStatement.executeUpdate(args[0].toString(), args[1].toInteger()));
            }
        } catch (SQLException e) {
            DriverManagerWrapper.exception(env, e.getMessage());
        }
    ...
    @Signature({@Arg(value = "sql"), @Arg(value = "columnIndexes", type = ARRAY)})
    public Memory executeUpdateWithIndexes(Environment env, Memory... args) {
        try {
            String sql = args[0].toString();
            ArrayMemory arr = (ArrayMemory) args[1];
            return LongMemory.valueOf(mStatement.executeUpdate(sql, MemoryUtil.toIntArray(arr)));
        } catch (SQLException e) {
            DriverManagerWrapper.exception(env, e.getMessage());
        }
        return NULL;
    ...
    @Signature({@Arg(value = "sql"), @Arg(value = "columnNames", type = ARRAY)})
    public Memory executeUpdateWithNames(Environment env, Memory... args) {
        try {
            String sql = args[0].toString();
            ArrayMemory arr = (ArrayMemory) args[1];
            return LongMemory.valueOf(mStatement.executeUpdate(sql, MemoryUtil.toStringArray(arr)));
        } catch (SQLException e) {
            DriverManagerWrapper.exception(env, e.getMessage());
        }
        return NULL;
    ...
    @Signature({@Arg(value = "current", optional = @Optional("NULL"))})
    ...
    public Memory setCursorName(Environment env, Memory... args) {
        try {
            mStatement.setCursorName(args[0].toString());
        } catch (SQLException e) {
            DriverManagerWrapper.exception(env, e.getMessage());
        }
        return NULL;
    ...
    @Signature({@Arg(value = "enable")})
    public Memory setEscapeProcessing(Environment env, Memory... args) {
        try {
            mStatement.setEscapeProcessing(args[0].toBoolean());
        } catch (SQLException e) {
            DriverManagerWrapper.exception(env, e.getMessage());
        }
        return NULL;
    ...
    @Signature({@Arg(value = "direction")})
    public Memory setFetchDirection(Environment env, Memory... args) {
        try {
            mStatement.setFetchDirection(args[0].toInteger());
        } catch (SQLException e) {
            DriverManagerWrapper.exception(env, e.getMessage());
        }
        return NULL;
    ...
    @Signature({@Arg(value = "rows")})
    public Memory setFetchSize(Environment env, Memory... args) {
        try {
            mStatement.setFetchSize(args[0].toInteger());
        } catch (SQLException e) {
            DriverManagerWrapper.exception(env, e.getMessage());
        }
        return NULL;
    ...
    @Signature({@Arg(value = "max")})
    public Memory setMaxFieldSize(Environment env, Memory... args) {
        try {
            mStatement.setMaxFieldSize(args[0].toInteger());
        } catch (SQLException e) {
            DriverManagerWrapper.exception(env, e.getMessage());
        }
        return NULL;
    ...
    @Signature({@Arg(value = "max")})
    public Memory setMaxRows(Environment env, Memory... args) {
        try {
            mStatement.setMaxRows(args[0].toInteger());
        } catch (SQLException e) {
            DriverManagerWrapper.exception(env, e.getMessage());
        }
        return NULL;
    ...
    @Signature({@Arg(value = "poolable")})
    public Memory setPoolable(Environment env, Memory... args) {
        try {
            mStatement.setPoolable(args[0].toBoolean());
        } catch (SQLException e) {
            DriverManagerWrapper.exception(env, e.getMessage());
        }
        return NULL;
    ...
    public Memory setQueryTimeout(Environment env, Memory... args) {
        try {
            mStatement.setQueryTimeout(args[0].toInteger());
        } catch (SQLException e) {
            DriverManagerWrapper.exception(env, e.getMessage());
        }
        return NULL;
